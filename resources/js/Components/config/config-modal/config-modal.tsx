    ...
    return (
        <AlertDialog>
            ...
            <AlertDialogContent className="max-w-screen-lg">
                ...
                <Tabs defaultValue="tags" orientation="vertical" className="flex gap-4">
                    <TabsList className="flex-col w-32 h-fit">
                        <TabsTrigger value="tags" className="w-full">Tags</TabsTrigger>
                        <TabsTrigger value="other" className="w-full">...</TabsTrigger>
                    </TabsList>
                    <TabsContent value="tags" className="w-full mt-0 min-h-96">
                        <ConfigDefaultTags />
                    </TabsContent>
                    <TabsContent value="other" className="w-full mt-0 min-h-96">Wip</TabsContent>
                </Tabs>
                <AlertDialogFooter>
